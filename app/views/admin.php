...
<div class="flex-1 p-10">
    ...
    <div class="grid grid-cols-3 gap-6">
        ...
        <div class="bg-gray-900 p-6 rounded-xl">
            <h3 class="text-gray-400">Kullanıcı</h3>
            <p class="text-3xl text-white"><?= $kullaniciSayisi ?></p>
        </div>

        <div class="bg-gray-900 p-6 rounded-xl">
            <h3 class="text-gray-400">Film</h3>
            <p class="text-3xl text-white"><?= $filmSayisi ?></p>
        </div>

        <div class="bg-gray-900 p-6 rounded-xl">
            <h3 class="text-gray-400">Rezervasyon</h3>
            <p class="text-3xl text-white"><?= $rezSayisi ?></p>
        </div>
